  ...
  return (
    <div className="w-full  flex items-center justify-center h-screen ">
      <div className="flex flex-col gap-10">
        <h1 className="text-[#91FCDC] text-3xl font-light">Hi, my name is</h1>
        <div className="text-7xl font-semibold gap-5 flex flex-col">
          <h1 className="text-[#CDD6F3] ">Sukhmanpreet Singh</h1>
          <h1 className="text-gray-500">I build things for the web.</h1>
        </div>

        <h1 className="text-gray-400 max-w-[50%] text-start text-lg font-light ">
